...
async def _manage(_, msg):
    ...
    how += '2) Visit https://t.me/nalayaksupport and define your problem **completely**, i.e, what you expected and what happened instead.'
    how += "If you don't get a reply, tag an admin."
    await msg.reply(
        how,
        reply_markup=InlineKeyboardMarkup([
            [InlineKeyboardButton('Support Group', url='https://t.me/nalayaksupport')]
        ]),
        quote=True
    )
